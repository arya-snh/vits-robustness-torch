...
class TRADESLoss(nn.Module):
    ...
    def forward(self, model: nn.Module, x: torch.Tensor, y: torch.Tensor,
        ...
        ## Mean KL Divergence with Class-Level Aggregation
        ## loss_robust_mean_kl_old refers to L2
        ## loss_robust_mean_kl_new refers to L3
        ...
        ## The following code utilises the creation of S matrix to implement Pairwise KL with Class-Specific Adversarials
